...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Repo":
		...
		case "List":
			...
			return (*Repo).List(&parent, ctx, token)
		case "WithBranch":
			var err error
			var parent Repo
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*Repo).WithBranch(&parent, ctx, branch)
		case "WithTag":
			var err error
			var parent Repo
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*Repo).WithTag(&parent, ctx, tag)
		case "WithWorkflowsDir":
			var err error
			var parent Repo
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Repo).WithWorkflowsDir(&parent, ctx, dir)
		case "Workflow":
			var err error
			var parent Repo
			err = json.Unmarshal(parentJSON, &parent)
