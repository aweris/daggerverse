...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Gh":
		...
		case "GetGithubCli":
			...
			return (*Gh).GetGithubCli(&parent, ctx, version)
		case "Run":
			var err error
			var parent Gh
			err = json.Unmarshal(parentJSON, &parent)
			...
			return (*Gh).Run(&parent, ctx, version, token, args)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"version\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"name\":\"GetGithubCli\",\"returnType\":{\"asObject\":{\"name\":\"File\"},\"kind\":\"ObjectKind\"}},{\"args\":[{\"name\":\"version\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"token\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"args\",\"typeDef\":{\"asList\":{\"elementTypeDef\":{\"kind\":\"StringKind\"}},\"kind\":\"ListKind\"}}],\"name\":\"Run\",\"returnType\":{\"kind\":\"StringKind\"}}],\"name\":\"Gh\"},\"kind\":\"ObjectKind\"}")
